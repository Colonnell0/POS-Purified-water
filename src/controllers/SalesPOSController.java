 ...
 * @author Colonnello
 */
public class SalesPOSController extends Dashboard_Model implements Initializable {
    ...
    public void tabulateData() {
        ...
        String res[][] = viewSalesReport(customerName, login_name, from, to, barangay, city, province, transactionType);
        if (res != null) {
            int i = 1;
            for (String[] re : res) {
